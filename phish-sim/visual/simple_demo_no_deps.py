...
class MockScreenshotCapture:
    ...
    def capture_screenshot(self, url, wait_for=None):
...
class MockDOMAnalyzer:
    ...
    def analyze_page(self, page, url):
...
for i, url in enumerate(sample_urls):
    result = screenshot_capture.capture_screenshot(url)
...
for i, url in enumerate(sample_urls):
    ...
    result = dom_analyzer.analyze_page(mock_page, url)
